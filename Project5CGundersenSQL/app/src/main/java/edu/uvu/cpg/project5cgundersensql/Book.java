...
public class Book implements Parcelable
{
    ...
    public Book(int imageID, String title, String author, int listRanking, int yearPublished, int rating, String description, boolean haveRead, boolean onPioneerOverdrive)
    {
